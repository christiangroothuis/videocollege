...
const videocollegeHelper = {
    ...
    responseHandler: (response) => {
        // get transaction
        const transaction = videocollegeHelper.transactions[response.requestId];
        ...
        transaction.responseHeaders['access-control-allow-origin'].value =
            transaction.requestHeaders.origin && transaction.requestHeaders.origin.value !== null
...
const bg = videocollegeHelper.init();
